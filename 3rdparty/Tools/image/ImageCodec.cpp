...
extern bool DecodeJpeg(const std::string &filename, unsigned char *buf, const unsigned int bufsize,
	const unsigned int width, const unsigned int height);
extern bool DecodeWebp(const std::string &filename, unsigned char *buf, const unsigned int bufsize,
	const unsigned int width, const unsigned int height);
extern bool DecodeJpegHeader(const string &filename, unsigned int &width, unsigned int &height);

bool DecodeImageHeader(const std::string &filename, unsigned int &width, unsigned int &height)
{
...
bool DecodeImage(const std::string &filename, unsigned char *buf, const unsigned int bufsize,
	const unsigned int width, const unsigned int height)
{
	if (filename.length() < 5) {
