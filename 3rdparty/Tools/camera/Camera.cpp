...
Camera::Camera(const Extrinsic &extrinsic, const Intrinsic &intrinsic)
	: mExtrinsic(extrinsic), mIntrinsic(intrinsic)
{}

void Camera::SetExtrinsic(const Extrinsic &extrinsic)
{
	mExtrinsic = extrinsic;
}

void Camera::SetIntrinsic(const Intrinsic &intrinsic)
{
...
glm::mat4 Camera::GetProjectionMatrix(float glnear, float glfar) const
{
