...
elseif (WIN32 AND EXISTS "${DEPENDS_DIR}/jpegturbo")
	...
	set(JPEG-TURBO_INCLUDE_DIRS "${DEPENDS_DIR}/jpegturbo/include")
	set(JPEG-TURBO_LIBRARIES "${DEPENDS_DIR}/jpegturbo/lib/win64/turbojpeg.lib")
	set(JPEG-TURBO_RUNTIME "${DEPENDS_DIR}/jpegturbo/lib/win64/turbojpeg.dll")
endif()